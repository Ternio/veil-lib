...
function addNetwork(data) {
  ...
  JSUtil.defineImmutable(network, {
    ...
    firstHalving: data.firstHalving
  });
...
addNetwork({
  ...
  // Veil extension prefixes
  // stealth: 0x84, // v

  // bech32 prefixes
  // hrpstealth: "sv", // stealth veil
  // hrpbase: "bv", // basecoin veil
  ...
  firstHalving: 518399 // not technically a halving, it's a 1/5thening
});
