...
<head>
  <meta charset="utf-8">
  <script src="bower_components/bitcore/vcore-lib.min.js"></script>
...
```sh
browserify --require ./index.js:vcore-lib | uglifyjs > vcore-lib.min.js
```

```sh
browserify --require ./index.js:bitcore-mnemonic --external vcore-lib | uglifyjs > bitcore-mnemonic.min.js
```
